<div class="modal fade" id="intiveGroup" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="mb-4" method="POST" action="{{route('add.group')}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" id="invite_emails" name="email" placeholder="Email address">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="invite_topic" name="topic" placeholder="Topic">
                    </div>
                ...
                <div class="d-flex justify-content-between">
                    <span>Users</span>
                    <span class="text-muted small" id="total_group">Total 3 users</span>
                </div>
                <hr>
                <div id="list_groups">
